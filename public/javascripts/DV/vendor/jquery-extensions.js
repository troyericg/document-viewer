(function($) {
  ...
  // Setup some nice defaults for Cross Domain ajax.
  // The withCredentials flag in particular is important.
  // without it, no cookies are sent
  $.ajaxSetup({
    dataType: 'json',
    xhrFields: {
    ...
    draggable : function(options) {
      ...
      this.each(function() {
        ...
        var checkEvent = function(e) {
          var isNonDraggable = $(e.target).closest('input, select, textarea, label, a, canvas, .tickLabel, .DV-minibutton, .text_link, .selectable_text, .not_draggable').length;
