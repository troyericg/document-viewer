...
(function(root) {
  ...
  _.i18n = {
    ...
    set: function( type, code ){
      if ( ! code && root.LANGUAGE_CODES ) {
        code = root.LANGUAGE_CODES[ type ];
      }
